...
<h1 id = "h1" >Connecting farmers with the market</h1>
<div class="container">
    <div class="cont1">
        <h2>For Farmers</h2>
        <p>Join over 2M farmers across the country and sell your crops at your home.</p>
        <button type="button" class=' login1 btn-lg btn-primary ' data.target = "modal" data.target = '#loginModal'>Login</button>
    </div>
    <div class="cont2">
        <h2>For Buyers</h2>
        <p>Login to purchase crops at the ease of your phone , by directly contacting the farmer.</p>
